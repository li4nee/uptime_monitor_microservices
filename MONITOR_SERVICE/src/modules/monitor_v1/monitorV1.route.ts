...
monitorV1Router.get("/history", Wrapper(MonitorController.getMonitoringHistory.bind(MonitorController)));
monitorV1Router.get("/overview", Wrapper(MonitorController.getOneMonthOverview.bind(MonitorController)));
